!(function (a) {
    ...
    a("#side-menu").metisMenu(),
        ...
        a("#vertical-menu-btn").on("click", function (t) {
            t.preventDefault(),
                a("body").toggleClass("sidebar-enable"), a("body #sidebar_email").toggleClass("remove-email-text"), a("body #sidebar_email_icon").toggleClass("has-icon"),
                992 <= a(window).width() &&
                    (null == e
                        ...
                        ? document.body.setAttribute("data-sidebar-size", "lg")
                        : document.body.setAttribute("data-sidebar-size", "sm"));
                        // document.getElementById('sidebar_email').style.display = "none";
                        // document.getElementById('sidebar_email_icon').style.display = "block";
        }),
